...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 ">
                <h2>Gerenciar Tarefas<a href="form-alterar-senha.php" class="btn btn-info">Alterar Senha</a>
                    <a href="logout.php" class="btn btn-danger">Sair</a></h5>
                </h2>
                <form action="admin.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="">
                    <div class="mb-3 mt-3">
                        <label for="tarefa" class="form-label">Tarefa:</label>
                        <input type="text" class="form-control" id="tarefa" name="tarefa" value="" required>
                    </div>
    ...
    <div class="col-md-10 ">
	    ...
	    <tr>
            <td>Trabalho</td>
            <td><a href='admin.php?editar=1'>✒</a></td>
            <td><a href='admin.php?apagar=1' onclick='return apagar();' >🗑</a></td>
        </tr>        </table>
		 <tr>
            <td>Estudo</td>
            <td><a href='admin.php?editar=1'>✒</a></td>
        ...
        <script>
            function apagar(){
                return confirm("Deseja realmente apagar esse registro?");
            }
        </script>
    </div>
</div>    </div>
